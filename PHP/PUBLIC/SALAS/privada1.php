<?php
// ===============================
// PRIVADA 1 - Vista de Sala PÃºblica
// ===============================

// Inicia sesiÃ³n
session_start();
// Requiere conexiÃ³n a BD
require_once '../../CONEXION/conexion.php';

// --- VERIFICACIÃ“N DE SESIÃ“N ---
// Comprueba que el usuario estÃ© logueado correctamente
if (!isset($_SESSION['loginok']) || $_SESSION['loginok'] !== true) {
    header("Location: ../login.php");
    exit();
}

// Comprueba que el username exista en la sesiÃ³n
...
// --- CONFIG SALA: PRIVADA 1 ---
$id_sala_actual = 6; 
$nombre_sala_actual = "Privada 1";

// --- OBTENER MESAS ---
// Mesas de la sala Privada 1
try {
...
<head>
    ...
    <!-- EspecÃ­fico de Privada 1 -->
    <link rel="stylesheet" href="../../../css/privada1.css">
    <!-- Estilo general para mesas privadas -->
...
<body>
    ...
    <div class="sala-container">
        <!-- Layout Sala Privada 1 -->
        <main class="sala-layout privada1">
            ...
            <?php foreach ($mesas as $mesa): ?>
                <?php 
                    ...
                    // Determinar acciÃ³n: asignar o liberar
                ...
                <a href="<?php echo $url_destino; ?>" class="mesa <?php echo $clase; ?>" id="mesa-<?php echo $mesa['id']; ?>" style="text-decoration: none; display: block; cursor: pointer;">
                    ...
                    <!-- Imagen especÃ­fica para Privada 1 -->
