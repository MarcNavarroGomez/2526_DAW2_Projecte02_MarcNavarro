<?php
// Inicia sesión para acceder a las variables de usuario
session_start();
// Conexión a base de datos
require_once __DIR__ . '/../CONEXION/conexion.php';

// --- Verificación de sesión ---
// Comprueba si el usuario está logueado correctamente
...
// Obtener rol del usuario (1 = Camarero, 2 = Admin)
$rol = $_SESSION['rol'] ?? 1;

// --- Obtener Mesa (GET) ---
// Recuperar ID seguro de la mesa
...
// --- Obtener datos de la Mesa y contexto ---
// Consulta SQL que une mesas con usuarios (para saber quién asignó) y salas (para contexto visual)
...
// --- Info Sala para redirección y visualización ---
$id_sala_actual = $mesa['id_sala'];
$sala_nombre = $mesa['sala_nombre'];
$sala_imagen = $mesa['sala_imagen'];
// URL para botón cancelar
$sala_redirect_url = 'sala.php?id=' . $id_sala_actual;

// --- Obtener tiempo de ocupación ---
// Busca el registro más reciente en 'ocupaciones' para esta mesa
// Esto sirve para mostrar cuanĺdo se ocupó
...
// Necesario para verificar permisos de liberación
$camarero_id_actual = $_SESSION['id_usuario'] ?? 0;

// Si el ID no está en sesión, se busca por username (seguridad adicional)
    ...
    <div class="sala-container">
        ...
        <main class="sala-layout" style="background-image: url('../../img/salas/<?= htmlspecialchars($sala_imagen ?? 'default.png') ?>');">
            ...
            <div class="interstitial-form">
                ...
                <!-- Lógica de permisos visual: Solo el propietario o Admin pueden liberar -->
                <?php 
                ...
                <!-- Formulario POST a PROCEDIMIENTO -->
                <form method="POST" action="../PROCEDIMIENTOS/liberar_mesa.php" id="liberar-mesa-form" class="form-full-page">
                    ...
                    <!-- Campos ocultos para uso de JS en confirmaciones -->
